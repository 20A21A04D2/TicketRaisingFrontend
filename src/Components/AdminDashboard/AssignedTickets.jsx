...
const PendingTickets = () => {
  ...
  useEffect(() => {
    axios.get('https://ticketraisingbackend.onrender.com/api/assigntickets')
  ...
  return (
    <div className="tickets-table-container_task">
      <h1 className="tickets-table-heading_task">Assigned Tickets</h1>
